        ...
        <main>
            ...
            <div className="container p7">
                ...
                <fieldset className="fieldset-vertical">
                    ...
                    <input className="input" placeholder="Название" type="text" value={q} onChange={(e)=> setQ(e.target.value)}></input>
                </fieldset>
                ...
                <fieldset className="fieldset-vertical fieldset-md">
                    ...
                    <div className="input-group">
                        <input className="input" placeholder="От" type="text" value={salary} onChange={(e)=> setSalary(e.target.value)}></input>
