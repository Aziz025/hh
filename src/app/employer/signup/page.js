            ...
            <section className="login-page">
                ...
                { step == 2 && <div className="card">
                    ...
                    <form>
                        ...
                        <input className="input"  placeholder="Фамилию" value={last_name} onChange={(e) => setSurname(e.target.value)}/>
                ...
                { step == 3 && <div className="card">
                    ...
                    <form>
                        ...
                        <input className="input"  placeholder="Адрес" value={company_address} onChange={(e) => setCompanyAdr(e.target.value)}/>
                        <input className="input" type='file'  placeholder="Лого" onChange={onLogoChange}/>
