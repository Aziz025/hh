        ...
        <main>
            ...
            <div className="container p7">
                ...
                <fieldset className="fieldset-vertical">
                    ...
                    <input className="input" placeholder="Название" type="text" value={name} onChange={(e)=> setName(e.target.value)}></input>
                </fieldset>
                ...
                <fieldset className="fieldset-vertical fieldset-md">
                    ...
                    <div className="input-group">
                        <input className="input" placeholder="От" type="text" value={salary_from} onChange={(e)=> setSalaryFrom(e.target.value)}></input>
                        <input className="input" placeholder="До" type="text" value={salary_to} onChange={(e)=> setSalaryTo(e.target.value)}></input>
                ...
                <fieldset className="fieldset-vertical">
                    <label>Адрес</label>
                    <input className="input" placeholder="Введите адрес" type="text" value={address} onChange={(e)=> setAddress(e.target.value)}></input>
                </fieldset>
                ...
                <fieldset className="fieldset-vertical fieldset-md">
                    ...
                    <div>
                        {empTypes.map(et => <div className="radio" key={et.id}>
                            <input type="radio" name="empType" value={et.id} onChange={(e) => setEmploymentType(e.target.value)} />
                            <label>{et.name}</label>
                        </div>)}
                    </div>
                </fieldset>
